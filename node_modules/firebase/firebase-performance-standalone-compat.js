...
/**
     ...
     */
<<<<<<< HEAD
function(e){je("@firebase/app-compat","0.3.3",e)}("lite");
=======
...
=======
     */let kr,Nr=3,Mr=[],Lr=!1;function Pr(e){setTimeout((()=>{0!==Nr&&(Mr.length>0&&Rr(),Pr(1e4))}),e)}function Rr(){const e=Mr.splice(0,1e3),t=e.map((e=>({source_extension_json_proto3:e.message,event_time_ms:String(e.eventTime)})));(function(e){const t=dr.getInstance().getFlTransportFullUrl(),n=JSON.stringify(e);return navigator.sendBeacon&&navigator.sendBeacon(t,n)?Promise.resolve():fetch(t,{method:"POST",body:n,keepalive:!0}).then()})({request_time_ms:String(Date.now()),client_info:{client_type:1,js_client_info:{}},log_source:dr.getInstance().logSource,log_event:t}).then((()=>{Nr=3})).catch((()=>{Mr=[...e,...Mr],Nr--,rr.info(`Tries left: ${Nr}.`),Pr(1e4)}))}function Br(e){return(...t)=>{!function(e){if(!e.eventTime||!e.message)throw nr.create("invalid cc log");Mr=[...Mr,e]}({message:e(...t),eventTime:Date.now()})}}function Fr(){for(;Mr.length>0;)Rr()}
>>>>>>> 3b008e380491e6ba2d199016330fcd7fa128de4c
/**
     * @license
     * Copyright 2020 Google LLC
...
/**
     ...
     */
<<<<<<< HEAD
var ti;(ti=nt).INTERNAL.registerComponent(new y("performance-compat",ei,"PUBLIC")),ti.registerVersion("@firebase/performance-compat","0.2.18");
=======
var ti;(ti=nt).INTERNAL.registerComponent(new y("performance-compat",ei,"PUBLIC")),ti.registerVersion("@firebase/performance-compat","0.2.14");
>>>>>>> 3b008e380491e6ba2d199016330fcd7fa128de4c
/**
     * @license
     * Copyright 2019 Google LLC
     ...
     */
<<<<<<< HEAD
return nt.registerVersion("firebase","11.7.3","compat-lite"),nt}));
=======
return nt.registerVersion("firebase","11.4.0","compat-lite"),nt}));
>>>>>>> 3b008e380491e6ba2d199016330fcd7fa128de4c
