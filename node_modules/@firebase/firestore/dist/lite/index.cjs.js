 ...
 * limitations under the License.
<<<<<<< HEAD
 */ const I = "ok", V = "cancelled", p = "unknown", y = "invalid-argument", g = "deadline-exceeded", w = "not-found", F = "already-exists", v = "permission-denied", D = "unauthenticated", b = "resource-exhausted", C = "failed-precondition", S = "aborted", N = "out-of-range", O = "unimplemented", q = "internal", B = "unavailable", $ = "data-loss";
=======
...
<<<<<<< HEAD
    ...
    V(t, e, r, n, i) {
        ...
        return this.v(t, o, a, r, _).then((e => (__PRIVATE_logDebug(U, `Received RPC '${t}' ${s}: `, e), 
        e)), (e => {
            throw __PRIVATE_logWarn(U, `RPC '${t}' ${s} failed with error: `, e, "url: ", o, "request:", r), 
            e;
        }));
    }
    D(t, e, r, n, i, s) {
...
class __PRIVATE_ExponentialBackoff {
     ...
     */ , i = 6e4) {
<<<<<<< HEAD
        this.U = t, this.timerId = e, this.j = r, this.W = n, this.K = i, this.G = 0, this.H = null, 
...
<<<<<<< HEAD
        ...
        this.H = this.U.enqueueAfterDelay(this.timerId, n, (() => (this.J = Date.now(), 
        t()))), 
...
<<<<<<< HEAD
    ...
    o.host !== ot && o.host !== u && __PRIVATE_logWarn("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used.");
...
<<<<<<< HEAD
        if (!deepEqual(_, a) && (t._setSettings(_), s && (pingServer(`https://${u}`), updateEmulatorBanner("Firestore", !0)), 
    n.mockUserToken)) {
=======
...
<<<<<<< HEAD
    ...
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.At, t.At);
=======
        super(t), this.ft = e;
    }
    _toFieldTransform(t) {
...
<<<<<<< HEAD
    ...
    isEqual(t) {
        return t instanceof __PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.At, t.At);
=======
        super(t), this.ft = e;
    }
    _toFieldTransform(t) {
...
<<<<<<< HEAD
    registerVersion("firestore-lite", A, ""), registerVersion("firestore-lite", A, "cjs2017");
=======
